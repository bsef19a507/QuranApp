package com.example.al_quran_android.adapter;
...
public class SurahAdapter extends RecyclerView.Adapter<SurahAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.totalAyah.setText( String.valueOf(list.get(position).getNumberOfAyahs()) + " Ayah");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView surahNo, englishName, arabicName, totalAyah;
        private SurahListener surahListener;
        ...
        public ViewHolder(@NonNull View itemView, SurahListener surahListener) {
            ...
            totalAyah = itemView.findViewById(R.id.total_aya);
